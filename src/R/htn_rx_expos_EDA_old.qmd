...
-   `base_`: BP extracts from Qardio at baseline visit, serving as *INDEX_DATE*
-   `elig_`: BP collected at two adjacent visits when eligibility criteria was satisfied
...
We define the following stratification groups: 1. based on eligibility sbp:
