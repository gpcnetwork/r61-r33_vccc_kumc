---
title: "Exploring potential explanations for BP variability"
author: "Xing Song"
format: 
  html:
    self-contained: true
...
## Investigation: How much of the BP variabilities can be explained by anti-hypertensive medication use during the run-in period?

For this investigation, we collected all prescription data following anti-HTN medications (using VA classifications) as well as their timings (start before eligibility visit or during the run-in period):
...
### Analysis I: Using systematic explanatory feature screening to investigate what are the explanatory factors for BP variabilities
